...
procedural helpers. Ruby `>= 3.2`; the gemspec allows Rails `>= 7.0`, but CI and Appraisals only
exercise `7.2` / `8.0` / `8.1`. Runtime dependencies: `rails`, `request_store`, `zeitwerk`.
